      ...
      schemas: {
        ...
        UserInfo: {
          ...
          properties: {
            ...
            providerStatus: { type: 'string', nullable: true, enum: ['PENDING_VERIFICATION', 'VERIFIED', 'REJECTED', 'SUSPENDED'] },
            providerVerificationStatus: { type: 'string', nullable: true, enum: ['PENDING_VERIFICATION', 'VERIFIED', 'REJECTED', 'SUSPENDED'] },
