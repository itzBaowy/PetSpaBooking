...
function IconMegaphone(props: SVGProps<SVGSVGElement>) {
  return (
    <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 5.882V19.24a1.76 1.76 0 01-2.64 1.526l-3.016-1.742A2.5 2.5 0 014 16.86V8.118a2.5 2.5 0 011.344-2.164L8.36 4.212A1.76 1.76 0 0111 5.882zm0 0l7.5-2.5A1.5 1.5 0 0120 4.805v14.39a1.5 1.5 0 01-1.5 1.423L11 18.118" />
    </svg>
  );
}
...
function IconCoin(props: SVGProps<SVGSVGElement>) {
  return (
    <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8V6m0 10v2M5 5h14a2 2 0 012 2v10a2 2 0 01-2 2H5a2 2 0 01-2-2V7a2 2 0 012-2z" />
    </svg>
  );
}
...
function IconReceipt(props: SVGProps<SVGSVGElement>) {
  return (
    <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 14l2 2 4-4M7 4h10a2 2 0 012 2v14l-3-2-3 2-3-2-3 2V6a2 2 0 012-2z" />
    </svg>
  );
}
...
function IconLog(props: SVGProps<SVGSVGElement>) {
  return (
    <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5h6m-8 4h10M7 13h10M7 17h6M5 3h14a1 1 0 011 1v16a1 1 0 01-1 1H5a1 1 0 01-1-1V4a1 1 0 011-1z" />
    </svg>
  );
}
...
export const adminNavGroups: NavGroup[] = [
  {
    ...
    items: [
      { label: "Tổng quan", href: "/admin", icon: <IconGrid /> },
    ],
  },
  {
    ...
    items: [
      ...
      { label: "Nhà cung cấp", href: "/admin/providers", icon: <IconBuilding /> },
    ],
  },
  {
    groupLabel: "Vận hành",
    items: [
      ...
      { label: "Xác thực", href: "/admin/verification", icon: <IconShield /> },
      { label: "Kiểm duyệt", href: "/admin/moderation", icon: <IconWarning /> },
    ],
  },
  {
    groupLabel: "Tăng trưởng",
    items: [
...
export const providerNavGroups: NavGroup[] = [
  {
    groupLabel: "Tổng quan",
    items: [
      { label: "Dashboard", href: "/provider", icon: <IconHome /> },
    ],
  },
  {
    groupLabel: "Quản lý dịch vụ",
    items: [
      { label: "Services", href: "/provider/services", icon: <IconClipboard /> },
      { label: "Bookings", href: "/provider/bookings", icon: <IconCalendar /> },
    ],
  },
  {
    groupLabel: "Khách hàng",
    items: [
      { label: "Customers", href: "/provider/customers", icon: <IconGroup /> },
    ],
  },
];
